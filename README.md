...
```bash
git clone https://github.com/RomanBogachev/Dropbox-Uploader/
```

or download the script manually using this command:

```bash
curl "https://raw.githubusercontent.com/RomanBogachev/Dropbox-Uploader/master/dropbox_uploader.sh" -o dropbox_uploader.sh
```
...
root@Dropbox:/$ ls
 ...
 [D] 0       Security
 [F] 105843  notes.txt
root@DropBox:/backup$ get notes.txt
```